...
namespace DrugManagement.Data.Helper
{
    /// <summary>
    ...
    public class RepositoryFactories
    {
        ...
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetDataMigrationFactories()
        {
        ...
        {
            _repositoryFactories = GetDataMigrationFactories();
        }
